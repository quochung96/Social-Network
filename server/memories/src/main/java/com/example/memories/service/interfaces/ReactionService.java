...
public interface ReactionService {
    Reactions createReaction(Reactions reactions) throws Exception;
    List<Reactions> getAllReactions();
    List<Reactions> getAllReactionsByPostId(Long postId) throws ReactionsNotFoundException;
    List<Reactions> getAllReactionsByCommentId(Long commentId) throws ReactionsNotFoundException;
