...
public class ReactionsController {
    ...
    public ResponseEntity getReactionById(@PathVariable @Min(value = 1, message = "Id must be greater than or equal to 1")Long id) throws ReactionsNotFoundException {
    ...
    public ResponseEntity deleteReaction(@PathVariable @Min(value = 1, message = "Id must be greater than or equal to 1") Long id) throws ReactionsNotFoundException{
