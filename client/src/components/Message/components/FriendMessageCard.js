...
const FriendMessageCard = () => {
  return (
    <Box display = 'flex' flexDirection = 'row' justifyContent = 'space-evenly' alignItems = 'center' gap = '20px' margin = '10px 20px' sx = {{background: 'white', borderRadius: 2, width: '90%', height: '70px',boxShadow: 'rgba(255,255,252, 0.2) 0px 7px 29px 0px','&:hover': {background: 'whitesmoke'}, cursor: 'pointer'}}>
